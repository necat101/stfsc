...
#[cfg(target_os = "android")]
use graphics::{GpuMesh, InstanceData};
            ...
            match xr_context.frame_waiter.wait() {
                Ok(frame_state) => {
                    ...
                    if frame_state.should_render {
                        ...
                        let left_proj_matrix = create_projection_matrix(left_view.fov, 0.01, 500.0);
                        ...
                        let right_proj_matrix =
                            create_projection_matrix(right_view.fov, 0.01, 500.0);
                            ...
                            unsafe {
                                ...
                                if let Ok(state) = game_state.try_read() {
                                    ...
                                    for (_id, (light, transform)) in state
                                        .world
                                        .ecs
                                        .query::<(&world::LightComponent, &world::Transform)>()
                                        .iter()
                                    {
                                ...
                                for eye_index in 0..2 {
                                    ...
                                    let proj_matrix =
                                        create_projection_matrix(view.fov, 0.01, 500.0);
